---
title: "BICC Ontario High School Academic Records & Ground Truth Extraction (2024-2025)"
type: academic_record
source_directory: "G:/My Drive/Kyubin_Yun_Workspace/00_Old_Files_Archive/01_2024_BICC_Ontario_HighSchool"
extracted_date: 2026-09-19
candidate: "Kyubin Yun (윤규빈)"
institution: "Birmingham International Collegiate of Canada (BICC)"
location: "Toronto, Ontario, Canada"
bsid: "668875"
curriculum: "Ontario Secondary School Diploma (OSSD)"
tags:
  - education
  - ground_truth
  - high_school
...
```mermaid
graph TD
    BICC["Birmingham International Collegiate of Canada<br/>(OSSD, Toronto, 2024-2025)"]
    
    BICC --> STEM["Advanced STEM Rigour"]
    BICC --> BIO_NEURO["Biological & Neuroscience Foundations"]
    BICC --> HUMANITIES["Rhetorical & Literary Analysis"]
    
    STEM --> MCV["MCV4U: Differential Calculus & 3D Vectors<br/>(Population Dynamics, Spatial Navigation)"]
    STEM --> MHF["MHF4U: Advanced Functions<br/>(Wave Interference & Holography)"]
    
    BIO_NEURO --> SBI["SBI4U: Biology<br/>(Dopamine Detox, Receptor Pathways, Homeostasis)"]
    BIO_NEURO --> HFA["HFA4U: Nutrition & Health<br/>(Global Food Security, Lifecycle Metabolism)"]
    
    HUMANITIES --> ENG["ENG4U/ENG3U/ESL<br/>(Life of Pi, Ibsen, Academic Rhetoric, Product Pitch)"]
    
    MCV --> UCL["UCL BSc Psychology & Language Sciences<br/>(Computational Cognitive Science, BCI, Experimental Design)"]
    SBI --> UCL
    HUMANITIES --> UCL
```
