---
description: "Rules for interacting with, formatting, and updating the Master Internship Tracker Excel file (2027_BCI_Internship_Tracker.xlsx)."
globs: ["**/*.xlsx", "**/*tracker*"]
alwaysApply: false
---
...
This rule file dictates how AI agents must interact with, format, and populate the Master Internship Tracker (`2027_BCI_Internship_Tracker.xlsx`).
